...
def open_quiz_window(sheet_name):
    ...
    quiz_window.geometry("700x600") # ← ウィンドウを少し大きくしたニャ！
    ...
    your_answer_text = tk.Text(quiz_window, height=5, font=("Helvetica", 12)) # ← これが入力エリアの正体ニャ！
    ...
    def show_next_question():
        ...
        answer_label.config(text="") # 前の答えを隠すニャ
        your_answer_text.delete("1.0", "end") # ★★★ 入力エリアを空っぽにするニャ！ ★★★

    def show_hint():
        """★★★ ヒントを表示する新しい呪文ニャ！ ★★★"""
        if current_question_row is not None:
            hint_text = current_question_row[HINT_COLUMN].iloc[0]
            answer_label.config(text=f"【ヒント】\n{hint_text}")
    ...
    # ★★★【君の答え】エリアを配置ニャ！ ★★★
    your_answer_label.pack(pady=(10, 0)) # 上に少しスペース
